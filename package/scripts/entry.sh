...
cd bin; ./apollo -apollo $APOLLO_HOST -dbhost $APOLLO_DB_HOST -dbname $APOLLO_DB_NAME -dbuser $APOLLO_DB_USER -dbpass $APOLLO_DB_PASSWD -dbtimeout $APOLLO_DB_TIMEOUT -iiif $APOLLO_IIIF_MAN_URL $DEVUSER_OPT
